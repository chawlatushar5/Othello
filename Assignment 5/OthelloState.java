...
public class OthelloState {
    ...
    public int Updatedscore() {
        ...
        if (!this.gameOver()) {
        		if (board[0][0]==PLAYER1) score+=4;
        		if (board[boardSize-1][0]==PLAYER1) score+=4;
        		if (board[0][boardSize-1]==PLAYER1) score+=4;
        		if (board[boardSize-1][boardSize-1]==PLAYER1) score+=4;
        		
        		if (board[0][0]==PLAYER2) score-=4;
        		if (board[boardSize-1][0]==PLAYER2) score-=4;
        		if (board[0][boardSize-1]==PLAYER2) score-=4;
        		if (board[boardSize-1][boardSize-1]==PLAYER2) score-=4;
        }
        return score;
    }
